(function($){
  ...
  function linkCells(matrix, r, c) {
    ...
    if (c > 0 && cell.left === undefined) {
      ...
      while (left[1] > 0 &&
             (matrix[left[0]][left[1]] === cell ||
              matrix[left[0]][left[1]].input === undefined)) {
    ...
    if (c < matrix[r].length-1 && cell.right === undefined) {
      var right = [r, c+1];
      while (right[1] < matrix[r].length &&
             (matrix[right[0]][right[1]] === cell ||
              matrix[right[0]][right[1]].input === undefined)) {
    ...
    if (r > 0 && cell.up === undefined) {
      ...
      while (up[0] > 0 &&
             (matrix[up[0]][up[1]] === cell ||
              matrix[up[0]][up[1]].input === undefined)) {
        up = [up[0]-1, up[1]];
      }
    ...
    if (r < matrix.length-1 && cell.down === undefined) {
      var down = [r+1, c];
      while (down[0] < matrix.length &&
             (matrix[down[0]][down[1]] === cell ||
              matrix[down[0]][down[1]].input === undefined)) {
