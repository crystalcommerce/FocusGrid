(function($){
  ...
  function createGrid($table, opts) {
    ...
    grid.options = opts;
    //FIXME: this doesn't quite work, but I feel like i'm close. this is what #jquery recommended
    $table.find('> tr, > tbody > tr, > thead > tr').each(function(r, tr){
      ...
      $(this).find('> td, > th').each(function() {
        ...
        if (opts.focus && cell.input === opts.focus) {
